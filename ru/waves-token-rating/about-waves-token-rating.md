...
Рейтинги токенов формируются на основе мнений участников сообщества об этом токене. В голосовании за токены могут принимать участие только держатели токенов WCT.

## Описание интерфейса Waves Token Rating
...
![](../waves-token-rating/waves-token-rating-pic/image2019-4-29_14-13-57.png)
...
![](../waves-token-rating/waves-token-rating-pic/image2019-4-29_12-55-21.png)
...
![](../waves-token-rating/waves-token-rating-pic/image2019-4-29_13-1-53.png)

### Выбор языка

Позволяет выбрать язык интерфейса \(русский или английский\).

![](../waves-token-rating/waves-token-rating-pic/image2019-4-29_12-58-41.png)

### F.A.Q.

Содержит ответы на часто задаваемые вопросы по Waves Token Rating.

![](../waves-token-rating/waves-token-rating-pic/image2019-4-29_12-59-53.png)
...
![](../waves-token-rating/waves-token-rating-pic/image2019-4-29_13-16-47.png)
...
В момент голосования записывается значение текущего баланса _**B **WCT. В течение 24 часов проверяются все **расходные **операции WCT по данному адресу и суммируется их объем. По истечении 24-х часов из _**B **_вычитается сумма исходящих за 24 часа транзакций токена WCT \(если были\). В результате получается эффективный баланс_**B. **Если его значение &gt; 0, применяем формулу \(1\) для расчета итогового веса.
...
_**B **_находится в промежутке_\[1, 10\], _в этом случае _**k = 1**_
