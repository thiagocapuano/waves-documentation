...
**let** — is a keyword, that assigns a value to a variable [lazy way](https://docs.scala-lang.org/sips/improved-lazy-val-initialization.html) (the word `let` works like lazy val in Scala language).
