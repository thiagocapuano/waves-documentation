...
A **callable function** is a [function](/ride/functions/functions.md) of a [dApp script](/blockchain/dapp-script.md) that has `@Callable` [annotation](/ride/annotations.md).
