...
Waves Platform allows to create and transfer any asset if its creator pays a fee. This lowers the threshold for entering the platform but opens up a lot of opportunities to send spam at a relatively low price.

Transfers are saved in blockchain and we should protect our users from trash assets. It could be possible with some kind of listings generated by token holders with voting system or by a trusted organization in compliance with established rules, access to which is public. 
