...
We want to protect our users from suspicious assets. It could be possible with some kind of listings generated by token holders with voting system or by a trusted organization in compliance with established rules, access to which is public.
