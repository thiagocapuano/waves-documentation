...
* [Mobile apps](waves-client/mobile-apps.md)
  * [Mobile app for iOS devices](waves-client/mobile-apps/iOS.md)
    * [iOS: Account Management](waves-client/mobile-apps/iOS/account-management.md)
      * [iOS: Account creation](waves-client/mobile-apps/iOS/account-management/creating-an-account.md)
      * [iOS: Account recovery](waves-client/mobile-apps/iOS/account-management/restore-an-account.md)
      * [iOS: Signing in to Your Account](waves-client/mobile-apps/iOS/account-management/signing-in-to-your-account.md)
      * [iOS: Use your Waves address](waves-client/mobile-apps/iOS/account-management/waves-address.md)
      * [iOS: Create a personal Alias](waves-client/mobile-apps/iOS/account-management/creating-an-alias.md)
      * [iOS: Lease Your Waves tokens](waves-client/mobile-apps/iOS/account-management/waves-leasing.md)
    * [iOS: Assets Management](waves-client/mobile-apps/iOS/assets-management.md)
      * [iOS: Token burning](waves-client/mobile-apps/iOS/assets-management/burn-an-asset.md)
    * [iOS: Transfers and gateways](waves-client/mobile-apps/iOS/wallet-management.md)
      * [iOS: Waves transfers](waves-client/mobile-apps/iOS/transfers-and-gateways/waves-transfers.md)
      * [iOS: Asset transfers](waves-client/mobile-apps/iOS/transfers-and-gateways/asset-transfers.md)
      * [iOS: Bitcoin transfers](waves-client/mobile-apps/iOS/transfers-and-gateways/bitcoin-transfers.md)
      * [iOS: Ethereum transfers](waves-client/mobile-apps/iOS/transfers-and-gateways/ethereum-transfers.md)
      * [iOS: Litecoin transfers](waves-client/mobile-apps/iOS/transfers-and-gateways/litecoin-transfers.md)
      * [iOS: Zcash transfers](waves-client/mobile-apps/iOS/transfers-and-gateways/zcash-transfers.md)
      * [iOS: Bitcoin Cash transfers](waves-client/mobile-apps/iOS/transfers-and-gateways/bitcoin-cash-transfers.md)
      * [iOS: Dash transfers](waves-client/mobile-apps/iOS/transfers-and-gateways/dash-transfers.md)
      * [iOS: Monero transfers](waves-client/mobile-apps/iOS/transfers-and-gateways/monero-transfers.md)
  ...
  * [Android: Mobile app for Android devices](waves-client/mobile-apps/android.md)
    * [Android: Account Management](waves-client/mobile-apps/android/account-management.md)
      ...
      * [Android: Signing in to Your Account](waves-client/mobile-apps/android/account-management/signing-in-to-your-account.md)
      * [Android: Use your Waves address](waves-client/mobile-apps/android/account-management/waves-address.md)
      * [Android: Create a personal Alias](waves-client/mobile-apps/android/account-management/creating-an-alias.md)
      * [Android: Lease Your Waves tokens](waves-client/mobile-apps/android/account-management/waves-leasing.md)
    * [Android: Assets Management](waves-client/mobile-apps/android/assets-management.md)
      * [Android: Token burning](waves-client/mobile-apps/android/assets-management/burn-an-asset.md)
    * [Android: Transfers and gateways](waves-client/mobile-apps/android/wallet-management.md)
      * [Android: Waves transfers](waves-client/mobile-apps/android/transfers-and-gateways/waves-transfers.md)
      * [Android: Asset transfers](waves-client/mobile-apps/android/transfers-and-gateways/asset-transfers.md)
      * [Android: Bitcoin transfers](waves-client/mobile-apps/android/transfers-and-gateways/bitcoin-transfers.md)
      * [Android: Ethereum transfers](waves-client/mobile-apps/android/transfers-and-gateways/ethereum-transfers.md)
      * [Android: Litecoin transfers](waves-client/mobile-apps/android/transfers-and-gateways/litecoin-transfers.md)
      * [Android: Zcash transfers](waves-client/mobile-apps/android/transfers-and-gateways/zcash-transfers.md)
      * [Android: Bitcoin Cash transfers](waves-client/mobile-apps/android/transfers-and-gateways/bitcoin-cash-transfers.md)
      * [Android: Dash transfers](waves-client/mobile-apps/android/transfers-and-gateways/dash-transfers.md)
      * [Android: Monero transfers](waves-client/mobile-apps/android/transfers-and-gateways/monero-transfers.md)
      * [Android: Buying Waves using credit or debit card](waves-client/mobile-apps/android/transfers-and-gateways/buying-waves-using-card.md)
...
* [Smart Assets](technical-details/smart-assets.md)
  * [Assets Distribution ](technical-details/smart-assets/assets-distribution.md)
